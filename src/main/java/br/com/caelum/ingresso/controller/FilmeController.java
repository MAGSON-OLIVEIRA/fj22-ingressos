...
public class FilmeController {
    ...
    public ModelAndView detalhe(@PathVariable("id") Integer id ) {
    	...
    	List<Sessao> sessoes = sessaoDao.buscarSessaoDoFilme(filme);
    	
    	
    	Optional<DetalhesDoFilme> detalhesFilme = client.request(filme, DetalhesDoFilme.class);
    	
    	model.addObject("sessoes", sessoes);
    	
    	model.addObject("detalhes", detalhesFilme.orElse(new DetalhesDoFilme()));
